...
class Scenario:
    ...
    def obstacle(self):
        ...
        self.po_x = rng.uniform(-limits.XO_MAX, limits.XO_MAX)
        self.po_y = rng.uniform(-limits.YO_MAX, limits.YO_MAX)
        self.po_r = rng.uniform(limits.RO_MIN, limits.RO_MAX)
    ...
    def initial_condition(self):
        ...
        self.px_0 = rng.uniform(-limits.X_MAX, limits.X_MAX)
        self.py_0 = rng.uniform(-limits.Y_MAX, limits.Y_MAX)
        self.psi_0 = rng.uniform(-np.pi, np.pi)
        self.V_0 = rng.uniform(limits.V_STALL, limits.V_MAX)
    ...
    def terminal_condition(self):
        ...
        d = 2*(self.po_r + R_min) + rng.uniform(0.5*R_min, 5*R_min)
